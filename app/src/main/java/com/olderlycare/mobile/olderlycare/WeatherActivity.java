...
public class WeatherActivity extends AppCompatActivity implements ServiceCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout)findViewById(R.id.drawerlayout_weather);
        ...
        navi.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (itemId){
                    case R.id.nav_carer:
                        Intent intent_carer = new Intent(WeatherActivity.this,
                    ...
                    case R.id.nav_medicine:
                        Intent intent_med = new Intent(WeatherActivity.this,
...
//                        startActivity(intent_wea);
    ...
    public void serviceSuccess(Channel channel){
        ...
        // 1ST forecast
        int foreResourceID1 = getResources().getIdentifier("drawable/icon_"+
                item.getForecast().getCode(1),null, getPackageName());
        ...
        firstDayHigh.setText(item.getForecast().getTemperatureHigh(1)+"\u00B0"+
                channel.getUnits().getTemperature());
        firstDayLow.setText(item.getForecast().getTemperatureLow(1)+"\u00B0"+
                channel.getUnits().getTemperature());

        // 2ND forecast
        int foreResourceID2 = getResources().getIdentifier("drawable/icon_"+
                item.getForecast().getCode(2),null, getPackageName());
        ...
        secondDayHigh.setText(item.getForecast().getTemperatureHigh(2)+
                "\u00B0"+channel.getUnits().getTemperature());
        secondDayLow.setText(item.getForecast().getTemperatureLow(2)+"\u00B0"+
                channel.getUnits().getTemperature());

        // 3RD forecast
        int foreResourceID3 = getResources().getIdentifier("drawable/icon_"+
                item.getForecast().getCode(3),null, getPackageName());
        ...
        thirdDayHigh.setText(item.getForecast().getTemperatureHigh(3)+"\u00B0" +
                channel.getUnits().getTemperature());
        thirdDayLow.setText(item.getForecast().getTemperatureLow(3)+"\u00B0" +
                channel.getUnits().getTemperature());

        // 4TH forecast
        int foreResourceID4 = getResources().getIdentifier("drawable/icon_"+
                item.getForecast().getCode(4),null, getPackageName());
        ...
        fourthDayHigh.setText(item.getForecast().getTemperatureHigh(4)+
                "\u00B0"+channel.getUnits().getTemperature());
        fourthDayLow.setText(item.getForecast().getTemperatureLow(4)+
                "\u00B0"+channel.getUnits().getTemperature());

        // 5TH forecast
        int foreResourceID5 = getResources().getIdentifier("drawable/icon_"+
                item.getForecast().getCode(5),null, getPackageName());
        ...
        fifthDayHigh.setText(item.getForecast().getTemperatureHigh(5)+
                "\u00B0"+channel.getUnits().getTemperature());
        fifthDayLow.setText(item.getForecast().getTemperatureLow(5)+
                "\u00B0"+channel.getUnits().getTemperature());

        // 6TH forecast
        int foreResourceID6 = getResources().getIdentifier("drawable/icon_"+
                item.getForecast().getCode(6),null, getPackageName());
        ...
        sixthDayHigh.setText(item.getForecast().getTemperatureHigh(6)+"\u00B0"+
                channel.getUnits().getTemperature());
        sixthDayLow.setText(item.getForecast().getTemperatureLow(6)+"\u00B0"+
                channel.getUnits().getTemperature());

        // 7TH forecast
        int foreResourceID7 = getResources().getIdentifier("drawable/icon_"+
                item.getForecast().getCode(7),null, getPackageName());
        ...
        seventhDayHigh.setText(item.getForecast().getTemperatureHigh(7)+
                "\u00B0"+channel.getUnits().getTemperature());
        seventhDayLow.setText(item.getForecast().getTemperatureLow(7)+
                "\u00B0"+channel.getUnits().getTemperature());
    ...
    public void setNotification(Item item){
        int resourceID = getResources().getIdentifier("drawable/icon_"+
                item.getCondition().getCode(),null, getPackageName());
        Drawable icon = getResources().getDrawable(resourceID,null);
        CharSequence NotificationContent = "Weather in "+service.getLocation()+
                " is "+item.getCondition().getDescription()+ ", "+
                item.getCondition().getTemperature();

        //app icon now using a sun
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this).setSmallIcon(R.drawable.icon_32).
                        setContentTitle("OrderlyCare").setContentText(NotificationContent);
